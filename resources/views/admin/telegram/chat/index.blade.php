<x-admin-layout>
    <x-slot name="navigation">
        <x-form.search :action="route('admin.telegram_bot.chat.index', $telegram_bot )" :placeholder="__('Search by chats')"/>
        <x-header.menu>
            <x-header.link href="{{ route('admin.telegram_bot.show', $telegram_bot) }}" :active="request()->routeIs('admin.telegram_bot.show*')">
                {{ __('Bot') }}
            </x-header.link>
            <x-header.link href="{{ route('admin.telegram_bot.chat.index', $telegram_bot ) }}" :active="request()->routeIs('admin.telegram_bot.chat.*')">
                {{ __('Chats') }}
            </x-header.link>
            <x-header.link href="{{ route('admin.telegram_bot.edit', $telegram_bot) }}" :active="request()->routeIs('admin.telegram_bot.edit.*')">
                {{ __('Settings') }}
            </x-header.link>
        </x-header.menu>
    </x-slot>
