<x-base-layout>
    ...
    <div class="pb-0 pt-0 lg:pt-10 lg:pb-0 flex w-full h-full flex-1">
        ...
        <div class="w-full sm:ml-72 xl:ml-96 h-full flex-1 flex flex-col">
            @if (isset($header))
            ...
            <main id="main-block" class="w-full space-y-4 flex-1" >
                {{ $slot }}
            </main>
