...
<a {{ $attributes->merge(['class' => 'border block text-left text-md font-base transition duration-150 ease-in-out cursor-pointer rounded-lg w-full lg:w-min text-gray-700 items-center flex text-center w-min' . $activeClasses]) }}>
